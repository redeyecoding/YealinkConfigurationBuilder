...
def build_yealink_config():
    ...
    suported_yealink_lines = {
        ...
        'COMPANY-NAME-YEALINK-CP960': YEALINK_2, 'COMPANY-NAME-YEALINK-T21P': YEALINK_2,
        'COMPANY-NAME-YEALINK-T23G': YEALINK_3, 'COMPANY-NAME-YEALINK-T40G': YEALINK_3, 
        'COMPANY-NAME-YEALINK-T40P': YEALINK_3, 'COMPANY-NAME-YEALINK-T41P': YEALINK_6 , 
        'COMPANY-NAME-YEALINK-T41S': YEALINK_6, 'COMPANY-NAME-YEALINK-T42G': YEALINK_12,
        'COMPANY-NAME-YEALINK-T42S': YEALINK_12, 'COMPANY-NAME-YEALINK-T43U': YEALINK_12, 
        'COMPANY-NAME-YEALINK-T46G': YEALINK_16, 'COMPANY-NAME-YEALINK-CP920': YEALINK_2,         
        'COMPANY-NAME-YEALINK-T46S': YEALINK_16, 'COMPANY-NAME-YEALINK-T48G': YEALINK_16,
        'COMPANY-NAME-YEALINK-T48S': YEALINK_16, 'COMPANY-NAME-YEALINK-T48U': YEALINK_16, 
        'COMPANY-NAME-YEALINK-T54W': YEALINK_16, 'COMPANY-NAME-YEALINK-T57W': YEALINK_16,
        'COMPANY-NAME-YEALINK-T58A': YEALINK_16, 'COMPANY-NAME-YEALINK-CP930': YEALINK_2, 
        'COMPANY-NAME-YEALINK-T46U': YEALINK_16, 'COMPANY-NAME-YEALINK-T53W': YEALINK_12,
        'COMPANY-NAME-YEALINK-W60P': YEALINK_6,'COMPANY-NAME-YEALINK-T31G': YEALINK_2,
        'COMPANY-NAME-YEALINK-935W': YEALINK_2
